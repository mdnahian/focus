...
def streamClassification(stream, modelName, modelType):
    # Load classifier:
    ...
    [Fs, x] = audioBasicIO.readAudioStream(stream)      # read audio file and convert to mono
    # print Fs
    # print x
    x = audioBasicIO.stereo2mono(x)
    # print x
